...
class Dejavu:
    ...
    def fingerprint_file(self, file_path: str, song_name: str = None) -> None:
        ...
        if song_hash in self.songhashes_set:
            ...
            song_name, hashes, file_hash = Dejavu._fingerprint_worker((file_path, self.limit)) #modified line
            sid = self.db.insert_song(song_name, file_hash, len(hashes)) #modified line
